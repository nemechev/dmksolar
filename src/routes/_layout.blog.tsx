...
const posts = [
  { title: "Як обрати сонячну станцію для будинку в 2026", date: "12.06.2026", img: house, excerpt: "Розбираємо потужність, тип панелей і чи потрібні акумулятори." },
  { title: "Кейс: СЕС 250 кВт для логістичного центру", date: "28.05.2026", img: biz, excerpt: "Як бізнес зекономив 3.2 млн грн за перший рік роботи СЕС." },
  { title: "Гібридний чи мережевий інвертор?", date: "10.05.2026", img: install, excerpt: "Порівнюємо два основні типи інверторів і області їх застосування." },
];
  ...
  return (
    <Section eyebrow={t("nav.blog")} title={t("blog.title")}>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {posts.map((p) => (
          <article key={p.title} className="bg-card rounded-xl overflow-hidden border border-border group">
